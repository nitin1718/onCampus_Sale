...
const UpdateProfile = ({ id, user }) => {
  ...
  const { dupUser, error, loading, updateProfile, clearErrors ,setDupUser} =
  ...
  useEffect(() => {
    if (dupUser) {
        toast.success("Profile Updated. Login again to see changes");
        setDupUser(false);
    }
  ...
  const uploadImage = async () => {
    ...
    formDataDup.append("file", avatar)
    formDataDup.append("upload_preset", UPLOAD_PRESET)
